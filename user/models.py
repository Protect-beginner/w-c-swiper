...
class UserConfig(models.Model):
    '''用户配置'''
    dating_gender = models.CharField(max_length=32, choices=(("male", "男"), ("female", "女")), default="male",
                                     verbose_name="性别",
                                     help_text="匹配性别")
    dating_location = models.CharField(max_length=64, verbose_name="目标城市", help_text="目标城市", default="上海市")
    ...
    vibration = models.BooleanField(verbose_name="开启震动", help_text="开启震动",
                                    default=1)
